...
ALTER TABLE ai.ocr_results ADD COLUMN IF NOT EXISTS ocr_quality text NOT NULL DEFAULT 'ok';
...
ALTER TABLE ai.ocr_results DROP CONSTRAINT IF EXISTS ocr_results_ocr_quality_check;
ALTER TABLE ai.ocr_results ADD CONSTRAINT ocr_results_ocr_quality_check
    CHECK (ocr_quality IN ('ok', 'needs_reupload')) NOT VALID;
ALTER TABLE ai.ocr_results VALIDATE CONSTRAINT ocr_results_ocr_quality_check;
